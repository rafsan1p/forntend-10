...
const UpdateService = () => {
    ...
    useEffect(() => {
        axios.get(`https://missionscic10-eight.vercel.app/services/${id}`)
        .then((res) => {
            setService(res.data);
    ...
    const handleUpdate = (e)=>{
        ...
        axios.put(`https://missionscic10-eight.vercel.app/update/${id}`, formData)
        .then((res) => {
            ...
            <div className="w-full max-w-3xl mx-auto">
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
                    <div className="bg-linear-to-r from-purple-600 to-pink-600 px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6">
                        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">Update Product</h2>
                        <p className="text-purple-100 mt-1 sm:mt-2 text-sm sm:text-base">Fill in the details to list your pet or product</p>
                    </div>

                    <form onSubmit={handleUpdate} className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 md:space-y-6">
                        <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                            ...
                            <div>
                                ...
                                <input defaultValue={service?.location}
                                    type="text"
                                    name="location"
                                    required
                        ...
                        <div>
                            ...
                            <input defaultValue={service?.image}
                                type="url"
                                name="image"
                                required
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input defaultValue={service?.date}
                                    type="date"
                                    name="date"
                                    required
                                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 outline-none"
