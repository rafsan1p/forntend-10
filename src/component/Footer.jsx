  ...
  return (
    <footer className="bg-linear-to-br from-blue-900 via-indigo-800 to-purple-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 lg:gap-12 xl:gap-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">PawMart</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors text-base flex items-center gap-2">
          ...
          {/* Services */}
          <div>
            <h4 className="text-xl font-bold mb-4 text-yellow-300">Our Services</h4>
            <ul className="space-y-3">
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors text-base flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-blue-200 text-base">
                <FaMapMarkerAlt className="text-yellow-400 mt-1 shrink-0" />
                <span>Khulna, Bangladesh</span>
              </li>
              <li className="flex items-center gap-3 text-blue-200 text-base">
                <FaPhone className="text-yellow-400 shrink-0" />
                <span>+8801758578404</span>
              </li>
              <li className="flex items-center gap-3 text-blue-200 text-base">
                <FaEnvelope className="text-yellow-400 shrink-0" />
                <span className="break-all">rubayetrafsan605@gmail.com</span>
              </li>
            </ul>
          </div>
